export let IMAGE_parameters = [
  ...
  { name: "<span class='param_positionX'>Position Horizontale</span>", refValue: "positionX", type: "variable" },
  { name: "<span class='param_positionY'>Position Verticale</span>", refValue: "positionY", type: "variable" },
  { name: "<span class='param_width'>Largeur</span>", refValue: "width", type: "variable" },
  { name: "<span class='param_height'>Hauteur</span>", refValue: "height", type: "variable" },
  { name: "<span class='param_rotation'>Rotation</span>", refValue: "angle", type: "angle", title: "Maintenez Shift pour aimanter la valeur sur les multiples de 15" },
  {
...
export let TEXT_parameters = [
  ...
  { name: "<span class='param_positionY'>Position Verticale</span>", refValue: "positionY", type: "variable" },
  { name: "<span class='param_rotation'>Rotation</span>", refValue: "angle", type: "angle", title: "Maintenez Shift pour aimanter la valeur sur les multiples de 15" },
  { name: "<span class='param_horizontalLimit'>Limite Horizontale</span>", refValue: "maxWidth", type: "variable" },
  {
...
export let TITLE_parameters = [
  ...
  { name: "<img src='assets/paramIcons/color.webp'class='spacerIcon'><span class='paramCat_font'>Aspect Visuel</span>", type: "catHeader" },
  { name: "<span class='param_targetWidth'>Largeur Cible</span>", refValue: "titleWidth", type: "variable" },
